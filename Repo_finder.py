...
def collect_page(search_date):
    items_list = []
    first_url = 'https://api.github.com/search/repositories?q=frontend+language:vue+created:' + search_date + \
...
with open('/Json files/Vue projects/' + '(2019-01-01)---(2019-06-30).json', 'w') as file:
    json.dump(data, file)
